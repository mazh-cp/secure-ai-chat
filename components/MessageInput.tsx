        ...
        <form onSubmit={handleSubmit}>
          <div className="flex space-x-4">
            ...
            <button
              ...
              className="glass-button text-theme px-6 py-3 rounded-xl font-medium disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none transition-all"
              style={{
          ...
          <p className="text-xs text-theme-muted mt-3 text-center" style={{ opacity: 0.8 }}>
