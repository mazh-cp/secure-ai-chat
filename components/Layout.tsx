...
export default function Layout({ children }: LayoutProps) {
  ...
  const [openAIStatus, setOpenAIStatus] = useState<'checking' | 'connected' | 'disconnected'>(
    'checking'
  )
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-1/2 right-1/2 w-full h-full bg-gradient-to-tl from-copper/20 via-harvest-gold/20 to-thunder/20 rounded-full blur-3xl animate-pulse"
      ...
      >
        <div
          className="h-full glass-dark rounded-r-3xl border-r-2 p-6 flex flex-col"
            ...
            {navigation.map(item => {
              ...
              return (
                <Link
                  ...
                  `}
                >
                  {isActive && <div className="absolute inset-0 liquid-shimmer"></div>}
          ...
          <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden sm:block glass-button px-4 py-2 rounded-full">
                <div
                  className="flex items-center space-x-2 text-base text-theme-muted"
                  title={
