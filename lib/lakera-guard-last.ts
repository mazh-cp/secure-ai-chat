/**
 * Best-effort in-process snapshot of the last Lakera Guard decision.
 * Exposed via GET /api/lakera/last for operator dashboards and live debugging.
 * In multi-instance deployments each Node process holds its own snapshot only.
 */
