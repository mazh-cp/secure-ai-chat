...
Welcome to Secure AI Chat! This guide will help you get the most out of the application's features, from secure conversations to file uploads and security scanning.
...
1. **Configure API Keys**
   ...
   - Add your **OpenAI API Key** (required for chat functionality)
...
2. **Choose Your Model**
   - On the Chat page, use the dropdown to select your preferred OpenAI model
...
You can choose from available OpenAI models based on your API key:
- **gpt-4o-mini** (default) - Fast and cost-effective
- **gpt-4o** - More capable, better for complex tasks
- **gpt-4-turbo** - Latest capabilities
- Other models available through your OpenAI account
