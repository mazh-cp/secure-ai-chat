...
if (existsSync(chatRoute)) {
  ...
  check(
    ...
    chatContent.includes('uploadedFiles') ||
      (chatContent.includes('file') && chatContent.includes('search')),
  ...
  check(
    ...
    chatContent.includes('listFiles') ||
      chatContent.includes('getFileContent') ||
      chatContent.includes('formatFileContentForRAG') ||
      chatContent.includes('enableRAG'),
  ...
  check(
    'Content matching algorithm',
    chatContent.includes('match') ||
      chatContent.includes('relevant') ||
      chatContent.includes('keyword'),
  ...
  check(
    'LLM instructions about files',
    chatContent.includes('uploaded files') ||
      chatContent.includes('available files') ||
      chatContent.includes('file context'),
  ...
  check(
    ...
    chatContent.includes('file context') ||
      chatContent.includes('fileContent') ||
      chatContent.includes('file content'),
...
if (existsSync(filesPage)) {
  ...
  check(
    ...
    filesContent.includes('10') &&
      (filesContent.includes('MB') || filesContent.includes('10 * 1024 * 1024')),
...
if (existsSync(chatRoute)) {
  const chatContent = readFileSync(chatRoute, 'utf8')
  if (
    chatContent.includes('5') &&
    (chatContent.includes('file') ||
      chatContent.includes('limit') ||
      chatContent.includes('slice(0, 5)'))
  ) {
    foundFileCountLimit = true
  }
}
...
check(
  ...
  foundFileCountLimit ||
    (existsSync(chatRoute) && readFileSync(chatRoute, 'utf8').includes('slice(0, 5)')),
...
if (existsSync(chatRoute)) {
  ...
  check(
    ...
    chatContent.includes('pending') ||
      chatContent.includes('not_scanned') ||
      (chatContent.includes('status') &&
  ...
  check(
    ...
    chatContent.includes('flagged') ||
      chatContent.includes('malicious') ||
...
if (existsSync(chatRoute)) {
  ...
  check(
    ...
    chatContent.includes('csv') ||
      chatContent.includes('json') ||
      chatContent.includes('txt') ||
      chatContent.includes('CSV') ||
      chatContent.includes('JSON') ||
      chatContent.includes('TXT'),
  ...
  check(
    ...
    chatContent.includes('length > 2') ||
      chatContent.includes('length >= 3') ||
      chatContent.includes('keyword') ||
      chatContent.includes('match'),
  ...
  check(
    ...
    chatContent.includes('fallback') ||
      (chatContent.includes('safe') && chatContent.includes('include')),
...
if (existsSync(chatRoute)) {
  ...
  check(
    ...
    chatContent.includes('system') &&
      (chatContent.includes('file') || chatContent.includes('uploaded')),
  ...
  check(
    ...
    chatContent.includes('cite') ||
      chatContent.includes('source') ||
      chatContent.includes('reference'),
...
if (existsSync(chatRoute)) {
  ...
  check(
    ...
    chatContent.includes('uploadedFiles') ||
      (chatContent.includes('files') &&
        (chatContent.includes('filter') ||
          chatContent.includes('find') ||
          chatContent.includes('search'))),
...
if (existsSync(chatRoute)) {
  ...
  check(
    ...
    chatContent.includes('truncate') ||
      chatContent.includes('substring') ||
