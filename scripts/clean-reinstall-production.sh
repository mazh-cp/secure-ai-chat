...
# Clean Reinstall Script for Secure AI Chat (production / remote)
# Full reinstall: stop systemd service, backup, remove app dir, reinstall from GitHub, restore backup.
# For local dev clean install use: npm run local:reset  (scripts/clean-reinstall.sh)
...
print_header "Secure AI Chat - Production Clean Reinstallation"
...
print_success "Secure AI Chat has been cleanly reinstalled"
echo ""
echo "Installation directory: $FULL_PATH"
echo "Version: $TAG"
echo ""
